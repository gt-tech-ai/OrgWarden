...
# Bug Reports
If you experience a problem with our software, please visit [issues](https://github.com/gt-tech-ai/OrgWarden/issues) and create a `Bug report`.

# Feature Requests
If you would like to suggest a new feature for our software, please visit [issues](https://github.com/gt-tech-ai/OrgWarden/issues) and create a `Feature request`.
...
## General information
For specific proposals, please provide them as *pull requests* or *issues* via our [GitHub site](https://github.com/gt-tech-ai/OrgWarden).

### Pull requests and different branches recommended
Pull requests are preferred, since they are specific. For more about how to create a pull request, see [GitHub docs](https://help.github.com/articles/using-pull-requests/).
...
We use GitHub to track proposed changes via its [issue tracker](https://docs.github.com/en/issues) and [pull requests](https://help.github.com/articles/using-pull-requests/). Specific changes are proposed using those mechanisms. Issues are assigned to an individual, who works and then marks it complete. If there are questions or objections, the conversation of that issue or pull request is used to resolve it.
